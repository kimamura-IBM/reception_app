...
class TwilioController < ApplicationController
  ...
  def call
    ...
    # HIPCHAT
    hipchat_client['Visitor'].send('UketsukeApp', "@#{@contact_to_hipchat} 【テスト送信_dev】受付Webアプリからの送信です。#{@contact_to}さんが呼び出されました。ステータス：呼び出し中。20秒後に通話ステータスを再確認します。", :message_format => 'text', :notify => true)
